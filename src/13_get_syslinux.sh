...
ARCHIVE_FILE=${SYSLINUX_SOURCE_URL##*/}
...
if [ ! "$USE_LOCAL_SOURCE" = "true" ] ; then
  # Delete object file.
  rm -f ${ARCHIVE_FILE}
  # Downloading SYSLINUX source bundle file. 
  echo "Downloading SYSLINUX source bundle from $DOWNLOAD_URL"
  curl -L $SYSLINUX_SOURCE_URL -o ${ARCHIVE_FILE}.down && mv ${ARCHIVE_FILE}{.down,} 
else
...
tar -xf $ARCHIVE_FILE -C ../work/syslinux
